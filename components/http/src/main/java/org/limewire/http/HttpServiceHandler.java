 ...
 */
public class HttpServiceHandler extends AsyncNHttpServiceHandler implements NHttpServiceHandler {
    ...
    private void processRequest(
        ...
        try {
            ...
            if (handler != null) {
                ...
                if (handler instanceof AsyncHttpRequestHandler) {
                    ...
                    //I won't create trigger since this method
                    //looks like it sends the response at the end
                    //with sendResponse()

                    NHttpResponseTrigger trigger = new NHttpResponseTrigger() {
        ...
        //the NHttpResponseTrigger should send the response, commenting this out
        //sendResponse(conn, response);
    }

    private void processAsyncRequest(final NHttpServerConnection conn, final NHttpRequestHandler handler,
