...
public class CustomWebIpCheck implements IPCheckProvider {
    ...
    public IP getExternalIP() throws IPCheckException {
        ...
        final String site = null;//JsonConfig.create(ReconnectConfig.class).getGlobalIPCheckUrl();
        final String patt = null;//JsonConfig.create(ReconnectConfig.class).getGlobalIPCheckPattern();
        ;
        try {
