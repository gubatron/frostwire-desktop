...
public final class GUIConstants {
     ...
     */
    public static final String MODEM_SPEED = I18n.tr("Dial Up");
    public static final String CABLE_SPEED = I18n.tr("Broadband");
    public static final String T1_SPEED = I18n.tr("T1");
    public static final String T3_SPEED = I18n.tr("T3 or Higher");
    public static final String MULTICAST_SPEED = I18n.tr("Ethernet");
