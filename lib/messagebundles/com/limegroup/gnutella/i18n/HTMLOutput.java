...
class HTMLOutput {
    ...
    static final String PRE_LINK = "http://www.frostwire.com/fisheye/viewrep/~raw,r=MAIN/limecvs/lib/messagebundles/";
    ...
    private static final String HTML_TRANSLATE_EMAIL_ADDRESS = "<script type=\"text/javascript\" language=\"JavaScript\"><!--\n"
            ...
            + "e_mA_iL_E = ('frostwire' + \"&#46;\" + 'com'); e_mA_iL_E = ('translate' + \"&#64;\" + e_mA_iL_E);\n"
    ...
    private void buildStartOfPage(StringBuffer newpage) {
        newpage
                .append("  <div id=\"bod1\">\n"
                        + "   <h1>Help Internationalize FrostWire!</h1>\n"
                        ...
                        "     The FrostWire Open Source Project has embarked on an effort to\n"
                        + "     internationalize FrostWire.&nbsp; If you are an avid English-speaking user\n"
                        ...
                        + "     <br />\n"
                        + "     <b>HOW FROSTWIRE SUPPORTS MULTIPLE LANGUAGES</b><br />\n"
                        + "     <br />\n"
                        + "     First, view this <a\n"
                        + "     href=\"http://www.frostwire.com/img/screenshots/search.jpg\"\n"
                        + "     target=\"_blank\">FrostWire screen-shot</a>.&nbsp; Notice how the tabs\n"
                        + "     (<b>Search</b>, <b>Monitor</b>, <b>Library</b>, etc.) and the buttons\n"
                        + "     (<b>Download</b>, <b>Cancel</b>, etc.) have text on them.&nbsp; All\n"
                        + "     elements of the FrostWire interface can be translated to any language very\n"
                        + "     easily.<br />\n"
                        + "     <br />\n"
                        ...
                        + "     <br />\n"
                        + "     When you start FrostWire, the program loads the appropriate message bundle\n"
                        ...
                        + "     meaning it is not used by FrostWire.&nbsp; The English translation will\n"
    ...
    private void buildStatus(StringBuffer newpage, List langsCompleted,
        ...
        buildStatus(
                newpage,
                langsStarted,
                "       are partly translated but still unfinished, and their use in FrostWire\n"
    ...
    private void buildAfterStatus(StringBuffer newpage) {
        newpage
                .append("     <b>GENERAL CONSIDERATIONS FOR TRANSLATORS</b><br />\n"
                        ...
                        + "     version of FrostWire.&nbsp; Make sure you <b>work on the latest version of\n"
                        ...
                        + "     href=\"http://www.frostwire.com/mailinglist.shtml\">subscribe to the\n"
                        ...
                        + "     which will work in FrostWire, and only for languages using the Western\n"
                        ...
                        + "     co-exist with the English version.&nbsp; FrostWire will load the\n"
                        + "     appropriate resource file according to the\n"
                        + "     &quot;<code>LANGUAGE=</code>&quot;, and &quot;<code>COUNTRY=</code>&quot;\n"
                        + "     settings stored in your &quot;<code>frostwire.props</code>&quot;\n"
                        ...
                        + "     FrostWire.&nbsp; All bundles are named\n"
