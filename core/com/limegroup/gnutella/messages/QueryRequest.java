...
public interface QueryRequest extends Message {
     ...
     * FrostWire's drop empty queries....
     */
    ...
    /** Mask for audio queries - input 0 | TORRENT_MASK | .... to specify
     *  torrent responses.
     */
    public static final int TORRENT_MASK = 0x0160;
    ...
    /** @return true if the query desires 'Torrent' results back.
     */
