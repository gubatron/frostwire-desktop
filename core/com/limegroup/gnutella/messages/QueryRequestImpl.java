...
//            }
    ...
    public boolean isQueryForLW() {
        for (String term : SearchSettings.LIME_SEARCH_TERMS.getValue()) {
            //System.out.println("***FTA DEBUG: LIME_SEARCH_TERMS: " + term);
            //System.out.println("***FTA DEBUG: QUERY_SEARCH_TERMS: " + getQuery().toLowerCase());
    ...
    public boolean desiresTorrents() {
        if (_metaMask != null) 
            return ((_metaMask.intValue() & TORRENT_MASK) > 0);
        return true;
    }
