...
public class SimppDataVerifier {
    ...
    public SimppDataVerifier(byte[] payload) {
        ...
        //System.out.println("Verifying payload STRING: " + new String (payload));
    }
    ...
    public boolean verifySource() {
        ...
        //System.out.print("Verifying source base32 is: " + base32);
    ...
    private PublicKey getPublicKey() {
        ...
        //System.out.println("Local key is: " + pubKeyBytes);
    ...
    static int findSeperator(byte[] data) {
        ...
        int i = 0;
        for( ; i< data.length; i++) {
	    //System.out.println("Current data is: " + data[i]);
            if(data[i] == SEP) {
            	//System.out.println("**FTA DEBUG: FOUND VALUE is: " + data[i]);
                found = true;
                break;
            }
        }
