...
public class LimeXMLDocument implements StringLookup {
    ...
    LimeXMLDocument(String xml, LicenseFactory licenseFactory,
        ...
        //System.out.println("***FTA DEBUG XML to construct is: " + xml);
    ...
    public LimeXMLSchema getSchema() {
        //System.out.println("FTA DEBUG CURRENT SCHEMA: " + limeXMLSchemaRepository.get().getSchema(schemaUri));
     ...
     * FTA: This function handles blue links in the search results window.
     * By returning "" ANY link will be disabled. This function was enabled for FrostWire future use
     * but is currently disabled because FrostWire is not using those blue links in the search results tab
     * in order to prevent spam messages.
     */
    public String getAction() {
    return "";
    /*
        if(action == null || 
           action.toLowerCase().contains("limewire.")) //shop.limewire.com, something.limewire.org, bla.limewire.net
            return "";
        else
            return action;
    */
    ...
    String getXmlWithVersion() {
        ...
        //System.out.println("FTA DEBUG xml with version: " + fullXML.toString());
        //System.out.println("FTA DEBUG SCHEMA: " + getSchema());
        return fullXML.toString();
    }
