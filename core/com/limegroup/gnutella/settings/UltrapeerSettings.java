...
public final class UltrapeerSettings extends LimeProps {
    ...
    public static final IntSetting MIN_UPSTREAM_REQUIRED =
        FACTORY.createRemoteIntSetting("MIN_UPSTREAM_REQUIRED",8,"UltrapeerSettings.MinUpstream",8,32);
    ...
    public static final IntSetting MIN_DOWNSTREAM_REQUIRED =
        FACTORY.createRemoteIntSetting("MIN_DOWNSTREAM_REQUIRED",16,"UltrapeerSettings.MinDownstream",16,64);
