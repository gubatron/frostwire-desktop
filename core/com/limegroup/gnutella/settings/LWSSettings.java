...
public final class LWSSettings extends LimeProps {
     ...
     */
    public static final StringSetting LWS_DOWNLOAD_HOSTNAME = FACTORY.createStringSetting("LWS_DOWNLOAD_HOSTNAME","http://www.riaa.com"); //make sure it'll never work just in case they manage to turn it on some other way
     ...
     */
    public static final BooleanSetting LWS_IS_ENABLED = FACTORY.createBooleanSetting("LWS_IS_ENABLED", false); 
     //NEVER IN FROSTWIRE
     //FACTORY.createRemoteBooleanSetting("LWS_IS_ENABLED", false, "LWSSettings.lwsIsEnabled");
