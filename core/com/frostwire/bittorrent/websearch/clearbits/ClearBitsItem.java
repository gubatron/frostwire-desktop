...
public class ClearBitsItem {
	...
	public String torrent_url; /** no longer available. calculated in fixItem() */
	
	/** web page about torrent on clearbits.net */
	public String location; /** no longer available. calculated in fixItem()
