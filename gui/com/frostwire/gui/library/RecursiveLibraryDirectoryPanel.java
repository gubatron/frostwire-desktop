...
public class RecursiveLibraryDirectoryPanel extends JPanel {
    ...
    private JPanel createLegendPanel(JPanel basePanel) {
        ...
        MultiLineLabel label = new MultiLineLabel(I18n.tr("Folder is fully added including all subfolders."), true);
        ...
        label = new MultiLineLabel(I18n.tr("Folder\'s files and some subfolders are included."), true);
        labelGbc.gridy = 2;
        panel.add(label, labelGbc);
