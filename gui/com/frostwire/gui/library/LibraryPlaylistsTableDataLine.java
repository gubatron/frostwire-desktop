...
public final class LibraryPlaylistsTableDataLine extends AbstractLibraryTableDataLine<PlaylistItem> {
     ...
     * Starred column
     */
    static final int STARRED_IDX = 1;
     ...
     * Bitrate column info
     */
    static final int BITRATE_IDX = 8;
     ...
     * Comment column info
     */
    static final int COMMENT_IDX = 9;
    ...
    public Object getValueAt(int idx) {
        ...
        switch (idx) {
        case SORT_INDEX_IDX:
            return new PlaylistItemProperty(String.valueOf(initializer.getSortIndex()), playing, exists, idx);
        case STARRED_IDX:
