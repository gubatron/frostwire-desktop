...
public class IconClearableAutoCompleteTextField extends ClearableAutoCompleteTextField {
	...
	public IconClearableAutoCompleteTextField() {
		super();
	}
	
	public IconClearableAutoCompleteTextField(int columns, Icon icon) {
		super(columns);
		setIcon(icon);
		
		ClearableAutoCompleteTextField dummy = new ClearableAutoCompleteTextField(columns);
		...
		addMouseMotionListener(new MouseAdapter() {
			...
			public void mouseMoved(MouseEvent e) {
				...
				if (_iconRectangle != null && 
					...
					if (!putHand) {
						putHand = true;
						IconClearableAutoCompleteTextField.this.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
					}
					...
					if (!putDefault) {
						putDefault =true;
						IconClearableAutoCompleteTextField.this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
					}
					putHand = false;
				}
			}
