...
/**
 * Old generation Slideshow panel (only supports image)
 * 
 * @author gubatron
 * @author aldenml
 *
 */
public class ImageSlideshowPanel extends JPanel implements SlideshowPanel {
    ...
    public ImageSlideshowPanel(List<Slide> slides, boolean randomStart) {
        setup(slides, false);
    }

    public ImageSlideshowPanel(final String url) {
