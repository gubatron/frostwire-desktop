...
public class CreativeCommonsSelectorPanel extends JPanel implements LicenseToggleButtonOnToggleListener {
    ...
    @Override
    public void onToggle(LicenseToggleButton button) {
        //logic to auto disable/enable license buttons depending on what's on.
    ...
    private void initComponents() {
        ...
        add(attribPanel,"aligny top, growx, gapbottom 5px, span 2, wrap");
    ...
    public static class LicenseToggleButton extends JPanel {
            ...
            addMouseListener(new MouseAdapter() {
               @Override
                public void mouseClicked(MouseEvent e) {
                   System.out.println("mouse clicked on " + licenseIcon);
                   onToggle();
                } 
            });
        }
        ...
        private void updateComponents() {
            System.out.println(licenseIcon + "-> selected? " + selected);
