...
public final class LimeLookAndFeel extends MetalLookAndFeel {
	...
	public LimeLookAndFeel() {
		setCurrentTheme(new LimeMetalTheme());
	}
    ...
    private static Object[] getComponentDefaults(UIDefaults table) {
		...
		Icon infoIcon      = GUIMediator.getThemeImage("notsearching");
		...
		Object[] defaults = {
		    ...
		    "ProgressBar.selectionForeground",new ColorUIResource(PlasticThemeSettings.WINDOW4_COLOR.getValue()),
            "ProgressBar.selectionBackground",new ColorUIResource(PlasticThemeSettings.WINDOW4_COLOR.getValue()),

		    "Label.font",                     labelFont,

		    "Table.foreground",               getUserTextColor(),
		    "Table.selectionForeground",      getUserTextColor(),
		    "Table.selectionBackground",      new ColorUIResource(PlasticThemeSettings.SECONDARY3_COLOR.getValue()),
		    "Table.focusCellForeground",      getUserTextColor(),
		    "Table.focusCellBackground",      new ColorUIResource(PlasticThemeSettings.SECONDARY3_COLOR.getValue()),
		    
		    "TableHeader.background",         new ColorUIResource(PlasticThemeSettings.TABLE_HEADER_BACKGROUND_COLOR.getValue()),
		    ...
		    "TextField.background",           new ColorUIResource(PlasticThemeSettings.WINDOW7_COLOR.getValue()),
		    ...
		    "Tree.selectionBackground",       new ColorUIResource(PlasticThemeSettings.SECONDARY3_COLOR.getValue()),
        };
