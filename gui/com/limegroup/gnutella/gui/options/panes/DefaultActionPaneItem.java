...
public class DefaultActionPaneItem extends AbstractPaneItem { 
    ...
    public final static String LABEL = I18n.tr("You can choose the default action that FrostWire will perform when you try to download a file that already exists on disk.");
