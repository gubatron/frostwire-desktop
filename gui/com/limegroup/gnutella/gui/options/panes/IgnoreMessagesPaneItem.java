...
public final class IgnoreMessagesPaneItem extends AbstractPaneItem {
	...
	public IgnoreMessagesPaneItem() {
		...
		addLabel(I18n.tr("FrostWire can also manage a blacklist for you.  This will keep FrostWire protected from harmful clients and other nuisances."));
		LabeledComponent labeledComponent = new LabeledComponent(I18n.tr("Use FrostWire's built-in blacklist"), networkBlackList, LabeledComponent.LEFT_GLUE, LabeledComponent.LEFT);
