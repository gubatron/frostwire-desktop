...
public final class SpeedPaneItem extends AbstractPaneItem {
    ...
    public final static String LABEL = I18n.tr("You can specify your connection speed so that FrostWire can optimize performance.");

	/**
	 * Array of constant names for connection speeds used throughout the gui.
	 */
    private final String[] SPEED_MENU_ITEMS = { GUIConstants.MODEM_SPEED, GUIConstants.CABLE_SPEED, GUIConstants.T1_SPEED, GUIConstants.T3_SPEED };
    ...
    private String getSpeedString(int i) {
        ...
        if (i == SpeedConstants.MODEM_SPEED_INT) {
            ...
            speed = GUIConstants.CABLE_SPEED; //FTA: Default connection value
        }
    ...
    private int getSpeedInt(String s) {
        ...
        if (s.equals(GUIConstants.MODEM_SPEED)) {
            ...
            i = SpeedConstants.CABLE_SPEED_INT; //FTA: Default connection value. Could be changed
        }
        return i;
    }
}
