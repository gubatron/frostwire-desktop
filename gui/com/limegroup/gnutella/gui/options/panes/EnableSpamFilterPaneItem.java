...
public final class EnableSpamFilterPaneItem extends AbstractPaneItem {
    ...
    public final static String LABEL = I18n.tr("You can disable FrostWire\'s junk filter and delete all previously collected filter data here, if your junk filter is rating too many files as spam.");
