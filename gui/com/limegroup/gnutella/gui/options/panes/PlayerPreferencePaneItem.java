...
public final class PlayerPreferencePaneItem extends AbstractPaneItem {
    ...
    public final static String LABEL = I18n.tr("You can choose to play media with FrostWire or your system\'s default player. The media player and playlist will appear only if this option is set. A restart will be required when enabling or disabling the media controls.");
	...
	private final String CHECK_BOX_LABEL = 
		I18nMarker.marktr("Use FrostWire Media Player:");
