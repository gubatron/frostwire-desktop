...
public final class DownloadMediator extends AbstractTableMediator<DownloadModel, DownloadDataLine, Downloader>
	...
	void editSelectedDownload() {
		...
		//Make sure they don't want to move the file to the FrostWire installation
		//directory
		String targetPath = saveFile.getAbsolutePath();
		
		if (targetPath.toLowerCase().startsWith(CoreFrostWireUtils.getInstallationFolder().toLowerCase())) {
