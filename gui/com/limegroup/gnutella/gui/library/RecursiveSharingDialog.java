...
public class RecursiveSharingDialog extends JDialog {
    ...
    private void initialize(File... roots) {
        ...
        // title label
        titleLabel =
            new MultiLineLabel(I18n.tr("The following folders and subfolders will be shared.  You can uncheck any folders you do not want to share.  (You can change your shared folders at any time in FrostWire\'s options.)"), 400, true);
