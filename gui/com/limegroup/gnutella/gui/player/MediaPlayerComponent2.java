 ...
 * MediaPlayer events.
 */
public final class MediaPlayerComponent2 implements AudioPlayerListener, RefreshListener, ThemeObserver {
     ...
     * The sole instance.
     */
    private static MediaPlayerComponent2 INSTANCE = null;
     ...
     */
    public static MediaPlayerComponent2 getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new MediaPlayerComponent2();
        }
        return INSTANCE;
    }
