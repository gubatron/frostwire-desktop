...
final class SchemaBox extends JPanel {
    ...
    SchemaBox() {
        ...
        SCHEMAS.setBackground(SkinHandler.getSearchGridColor());
    ...
    private void addMediaType(NamedMediaType type, String toolTip) {
        ...
        if(type.getMediaType().equals(MediaType.TYPE_TORRENTS))
    ...
    private static class Highlighter implements ItemListener {
        public void itemStateChanged(ItemEvent e) {
            ...
            if(e.getStateChange() == ItemEvent.SELECTED) {
                ...
                parent.setBackground(SkinHandler.getFilterTitleColor());
            } else {
