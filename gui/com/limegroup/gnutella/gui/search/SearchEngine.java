...
public abstract class SearchEngine {
    ...
    public static final SearchEngine TPB = new SearchEngine(TPB_ID, "TPB", SearchEnginesSettings.TPB_SEARCH_ENABLED, DOMAIN_ALIAS_MANAGER_BROKER.getDomainAliasManager("thepiratebay.pe")) {
        @Override
        public SearchPerformer getPerformer(long token, String keywords) {
