...
public class ThirdPartySearchResult extends AbstractSearchResult implements Linkable {
    ...
    private final static Log LOG = LogFactory.getLog(ThirdPartySearchResult.class);
    ...
    public ThirdPartySearchResult(String name, String type, String url, int size,
            long creationTime, LimeXMLDocument xmlDoc, String vendor, String keyword) {
        this.name = name;
        this.url = url;
        this.size = size;
    ...
    public Color getEvenRowColor() {
        return SkinHandler.getTableSpecialBackgroundColor();
    }

    public Color getOddRowColor() {
        return SkinHandler.getTableSpecialAlternateColor();
    }
